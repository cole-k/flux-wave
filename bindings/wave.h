...
void hostcall_wasi_snapshot_preview1_proc_exit_wave(void *_ctx,
                                                    int32_t _x);
...
void Z_wasi_snapshot_preview1Z_proc_exitZ_vi(void *_ctx,
                                             uint32_t x);
...
uint32_t _Z_wasi_snapshot_preview1Z_fd_fdstat_set_rightsZ_iijj(void *_ctx,
                                                               uint32_t _a,
                                                               uint64_t _b,
                                                               uint64_t _c);
